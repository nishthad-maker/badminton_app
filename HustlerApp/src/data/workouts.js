...
const workouts = {
  ...
  recovery: [
    ...
    },
    {
      ...
      subcategory: 'recovery',
      logType: 'recovery',
      description: 'After practice or on rest days to loosen tight muscles and improve blood flow. It helps your legs, back, and shoulders feel less stiff after repeated badminton movement.',
    ...
    },
    {
      ...
      subcategory: 'recovery',
      logType: 'recovery',
      description: 'After training to release tightness in your shoulders, arms, and back from racket swings and overhead shots. Keeps your upper body loose for the next session.',
    ...
    },
    {
      ...
      subcategory: 'recovery',
      logType: 'recovery',
      description: 'After training to release tightness in your legs and hips from lunging, jumping, and fast court movement. Keeps your lower body flexible for the next session.',
